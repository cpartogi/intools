...
<div class="">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Hubless City & Implant</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
...
<script>
  ...
  $("#cari").on("click", function() {
    ...
    var t = $('#table-hub').DataTable({
      ...
      autoWidth: false,
      ajax: {
        url: '{{route("list_hubless")}}?&logistic_id=' + logistic_id + '&city_id=' + city_id,
        error: function(err) {
  ...
  function initHublessSwicthAction() {
    $('.tgl-hubless').change(function() {
      ...
      var ajaxurl = '{{route("switch_hubless")}}?id=' + $(this).data('id') + "&prop_hubless=" + $(this).prop('checked') + "&prop_implant=" + implant + "&type=HUBLESS";
      $.ajax({
        type: "GET",
        url: ajaxurl,
        success: function(data) {
    ...
    $('.tgl-implant').change(function() {
      ...
      var ajaxurl = '{{route("switch_hubless")}}?id=' + $(this).data('idimplant') + "&prop_implant=" + $(this).prop('checked') + "&prop_hubless=" + hubless + "&type=IMPLANT";
      $.ajax({
        type: "GET",
        url: ajaxurl,
        success: function(data) {
